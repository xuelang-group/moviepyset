...
def addSubtitlesForTail(context):
    args = context.args
    infile = args['inFile']
    ...
    imageClip = credits1(txtpath, txt_width, stretch=30, color=txt_color, fontsize=font_size, stroke_color=stroke_color, gap=gap) #加载字幕文件
    w,h = clip.size
    ...
    finalclip = concatenate_videoclips([clip,imageClip.set_duration(5)]) #合并视频和字幕
